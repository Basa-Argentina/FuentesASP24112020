...
@WebAppConfiguration
public class HojaRutaControllerTest {
    ...
    public void ultimasTest() throws Exception {
        mockMvc.perform(get("/hoja_de_ruta/1.00/"))
    ...
    /**
     * Testing "/hoja_de_ruta/{hdr}/save" service
     *
     * Fail test:
     * status expected = 400
     * {hdr} # of HdR to save
     * Content expected OperacionesWrapper Jason
     *      {"operaciones": List<Operaciones>}
     *      to update HdR�s #
     *      Wrong content sent
     *      Jason {List<Operaciones>}
     *
     */
    @Test
    ...
    /**
     * Testing "/hoja_de_ruta/generate_map" service
     *
     * Fail test:
     * status expected = 400
     * Content expected OperacionesWrapper Jason
